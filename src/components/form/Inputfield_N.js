...
export default class Inputfield_N extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    ...
    return (
      <View style={[customStyle, styles.wrapper]}>
        ...
        <TextInput
          style={[{color: inputColor, borderBottomColor: borderBottom}, inputStyle, styles.Inputfield_N]}
